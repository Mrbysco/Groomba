...
public abstract class MoveInsideBlockGoal extends Goal {
	private static final int GIVE_UP_TICKS = 600;
	private static final int STAY_TICKS = 600;
	...
	public MoveInsideBlockGoal(PathfinderMob mob, double speedModifier, int searchRange) {
		this(mob, speedModifier, searchRange, 1);
	}

	public MoveInsideBlockGoal(PathfinderMob mob, double speedModifier, int searchRange, int verticalSearchRange) {
		this.mob = mob;
	...
	protected int nextStartTick(PathfinderMob pathfinderMob) {
		return reducedTickDelay(INTERVAL_TICKS + pathfinderMob.getRandom().nextInt(INTERVAL_TICKS));
	}
